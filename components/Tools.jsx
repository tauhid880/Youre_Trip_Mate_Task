    ...
    <div className="my-10 lg:my-36 relative">
      <Wrapper>
        <div>
          ...
          <div className="grid grid-cols-4 content-around justify-items-center gap-x-[100px] gap-y-[30px]">
            <div className="w-[304px] h-[120px] bg-[#282A37] rounded-lg ">
              <img
                className="bg-transparent relative left-6 top-7 bottom-14 h-9"
                src="/image1.png"
                alt=""
              />
              <div className="bg-transparent relative left-[70px] -top-4">
                <h3 className="bg-transparent">Blog Headlines</h3>
                <p className="text-[#b7b8bb] mt-3 bg-transparent font-inter text-sm leading-5">
          ...
          <div className="text-center mt-[64px] hover:text-[#b7b8bb] font-semibold font-inter text-base leading-6">
            <p>See all 54 available tools</p>
          </div>
        </div>
      </Wrapper>
    </div>
